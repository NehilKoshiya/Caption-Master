...
class _SettingsViewState extends State<SettingsView> {
  final SettingController settingController = SettingController().initialized ? Get.find() :Get.put(SettingController());
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Divider(height: 30),
            rowData(text: "Privacy policy", icon: Icons.privacy_tip_outlined,
              onTap: () {
            ...
            Divider(height: 30),
            rowData(text: "Rate 5 Star", icon: Icons.star_border,onTap: () {
              settingController.openPlayStore();
            },),
            Divider(height: 30),
            rowData(text: "Share App", icon: Icons.share_outlined,onTap: () {
  ...
  Widget buildNativeAd() {
    return Obx(() {
      if (AdService.isNativeBannerAdLoaded.value && AdService.nativeBannerAd != null) {
        return Container(
          height: 150,
